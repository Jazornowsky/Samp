/*
	*       GangZone Editor FS created by Lorenc_
	*           	  Version: 1.0b
	*
	*   - Credits:
	*       Zamaroht - Colors/sounds    Dracoblue - HexToInt( )
	*       ZeeX - zcmd                 Lorenc_ - Barbequing the script
	*
	*
*/
...
#define COLOR_MSG                   0xFAF0CEFF // Stolen from TextDrawEditor1.0
#define COLOR_ZONE                  3402287696

#define D_TITLE                     "Gang Zone Editor - By Lorenc_"
#define DIALOG_NEW_PROJECT          500
#define DIALOG_PROJECT_CONFIG       501
#define DIALOG_ZONE_MANAGE          502
#define DIALOG_ZONE_MODIFY          503
#define DIALOG_ZONE_MODIFY_XY       504
#define DIALOG_ZONE_MODIFY_COLOR    505
#define DIALOG_ZONE_MODIFY_DEL      506
...
{
	print( " - Gang Zone Editor v"#FILE_VERSION" by Lorenc_ Loaded!" );
	return 1;
}
	    ...
	    switch( listitem )
	    {
	        ...
	        case 2:
	        {
	            if( g_totalZones )
	            {
					...
					iFile = fopen( string );
					fwrite( iFile, "Vote Lorenc for president :D\r\n\r\n" );
