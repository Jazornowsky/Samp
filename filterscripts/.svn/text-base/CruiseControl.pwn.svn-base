...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if (strcmp(cmd, "/tempomat", true) == 0)
	{
      	...
      	SendClientMessage(playerid, COLOR_MESSAGE_YELLOW, "Tempomat pozwala na utrzymanie sta³ej prêdkoœci bez potrzeby ci¹g³ego wciskania klawisza W");
      	SendClientMessage(playerid, COLOR_MESSAGE_YELLOW, "Aby u¿yæ tempomatu rozpêdŸ swój pojazd do odpowiedniej prêdkoœci i przytrzymaj klawisz LCTRL");
      	return 1;
    }
	return 0;
}
