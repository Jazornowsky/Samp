...
CMD:interiory(playerid, cmdtext[]) 
{ 
   if(!IsPlayerAdmin(playerid)) return 0; 
   ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
   return 1; 
} 
...
//                                24/7's 
//============================================================================== 
   else if(dialogid == INTERIORMENU+1 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 6: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
//                                Airports 
//============================================================================== 
   else if(dialogid == INTERIORMENU+2 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 7: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
//                                Ammunation 
//============================================================================== 
   else if(dialogid == INTERIORMENU+3 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Houses 
//============================================================================== 
   else if(dialogid == INTERIORMENU+4 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Safe Houses 
//============================================================================== 
   else if(dialogid == INTERIORMENU+5 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 9: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
...
//                                Missions 1 
//============================================================================== 
   else if(dialogid == INTERIORMENU+6 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 10: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
...
//                                Missions 2 
//============================================================================== 
   else if(dialogid == INTERIORMENU+7 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 5: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
//                                Casino Interiors 
//============================================================================== 
   else if(dialogid == INTERIORMENU+8 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 8: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
//                                Shop Interiors 
//============================================================================== 
   else if(dialogid == INTERIORMENU+9 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Mod Shops/Garages 
//============================================================================== 
   else if(dialogid == INTERIORMENU+10 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 4: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
...
//============================================================================== 
   else if(dialogid == INTERIORMENU+11 && response) 
   { 
		 switch(listitem) 
		 { 
...
//============================================================================== 
   else if(dialogid == INTERIORMENU+12 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Resturants/Clubs 
//============================================================================== 
   else if(dialogid == INTERIORMENU+13 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                No Specific Group 
//============================================================================== 
   else if(dialogid == INTERIORMENU+14 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Burglary Houses 1 
//============================================================================== 
   else if(dialogid == INTERIORMENU+15 && response) // 
   { 
		 switch(listitem) 
		 { 
...
//                                Burglary Houses 2 
//============================================================================== 
   else if(dialogid == INTERIORMENU+16 && response) 
   { 
		 switch(listitem) 
		 { 
...
//                                Gyms 
//============================================================================== 
   else if(dialogid == INTERIORMENU+17 && response) 
   { 
		 switch(listitem) 
		 { 
			   ...
			   case 3: ShowPlayerDialog(playerid, INTERIORMENU, DIALOG_STYLE_LIST, "Interiors Menu","24/7's\nAirports\nAmmunations\nHouses\nHouses 2\nMissions\nStadiums\nCasinos\nShops\nGarages\nGirlfriends\nClothing/Barber Store\nResturants/Clubs\nNo Category\nBurglary\nBurglary 2\nGym\nDepartment\nWorld Locations", "Select", "Cancel"); 
		 } 
		 return 1; 
   } 
//============================================================================== 
//                          Deparments 
//============================================================================== 
   else if(dialogid == INTERIORMENU+18 && response) 
   { 
	   switch(listitem) 
	   { 
...
//                          World Locations 
//============================================================================== 
   else if(dialogid == INTERIORMENU+19 && response) 
   { 
	   switch(listitem) 
	   { 
