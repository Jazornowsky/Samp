#define IGNORE_PASSENGERS // Kommenteld ki, ha szeretnéd, hogy az anyósölésen ülõk is ilyen nézetben utazzanak!
...
public OnFilterScriptExit()	return print("eDriveCam by Epsilon unloaded.");
...
public OnPlayerDisconnect(playerid, reason) { if(IsValidPlayerObject(playerid,dcObject[playerid])==1) DestroyPlayerObject(playerid,dcObject[playerid]); return 1; }
