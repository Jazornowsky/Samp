// Vehicle mod saving FS by Fresh Killa.

#include <a_samp>

#define CUSTOM_MAX_VEHICLES 500
...
new VehiclesMod[CUSTOM_MAX_VEHICLES][11];
...
public Starting()
{
    for(new v = 0; v < CUSTOM_MAX_VEHICLES; v++)
    {
        LoadComponents(v);
    }
}
